...
This repo is a part of an [Electrocardiograph (ECG) Circuit Design and Software-based Processing using MATLAB](https://drive.google.com/file/d/1FEdh7YL6a9QvQ47rRdb2RFLzPfmwScsg/view?usp=sharing) system utilizing the **MATLAB** environment. The code captures ECG signals directly from an audio input (such as a microphone or line-in) and processes them in real-time.
